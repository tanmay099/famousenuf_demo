...
class Navbar extends  React.Component {
    ...
    render(){
        ...
        let a3 = ["a3"];
        let a = ["a"];
        let tablet_sigup_bg = ["tablet_sigup_bg"];
...
console.log(collapse);
        ...
        // }
        return(
 <div  style={tablet_sigup_bg} className={wrapper.join(' ')}>
      ...
      <a style={{ textDecoration: 'none' }} href="http://famousenuf.com"><div className="title_div">FAMOUS<span id="logo_color">ENUF</span></div></a>
          ...
          <span style={{color:'#FFA800'}}className={signUp_mobile.join(' ')}>Book a demo</span>
          </div>
         ...
         <div class="navbar_space1"></div>
          ...
          {/* <li className={"li"}><Link className="a3" to="" style={{ textDecoration: 'none' }}><span >FAQs</span></Link></li> */}

          <li className={""}><a onClick={this.handleColor} href="http://brand.famousenuf.com" style={{ textDecoration: 'none' }}  className={a3} >Login</a></li>
          <li className="five"><Link onClick={this.handleColor2} to="/signup/:email"  style={{ textDecoration: 'none' }}><span  className={five2.join(' ')}>Book a demo</span></Link></li>
