 ...
 <div className={wrapper.join(' ')}>
      ...
      <a style={{ textDecoration: 'none' }} href="http://famousenuf.com"><div className="title_div">FAMOUS<span id="logo_color">ENUF</span></div></a>
         ...
         <div class="navbar_space1"></div>
          ...
          <li className={""}><a onClick={this.handleColor} href="http://brand.famousenuf.com" style={{ textDecoration: 'none' }}  className={a.join(' ')} >Login</a></li>
          <li className="five"><Link onClick={this.handleColor2} to="/signup/:email"  style={{ textDecoration: 'none' }}><span  className={five.join(' ')}>Get demo</span></Link></li>
