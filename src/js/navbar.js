...
console.log(collapse);
 ...
 <div className={wrapper.join(' ')}>
      ...
      <a style={{ textDecoration: 'none' }} href="http://famousenuf.com"><div className="title_div">FAMOUS<span id="logo_color">ENUF</span></div></a>
          ...
          <span className={signUp_mobile.join(' ')}><Link style={{textDecoration: 'none' ,  color: 'white'}} to="/signup/:email">Book a demo</Link></span>
          </div>
         <div className={navbarcss.join(' ')}>
         <div class="navbar_space1"></div>
              <ul className={simplelist.join(' ')}>
          <li className="li.collapsed"><Link onClick={this.handleColor} className={a.join(' ')} to="/" style={{ textDecoration: 'none' }}>Home</Link></li>
          {/* <li className={"li"}><Link className="a3" to="" to="/faq" style={{ textDecoration: 'none' }}><span >Privacy Plolicy</span></Link></li> */}

          <li className={""}><a onClick={this.handleColor} href="http://brand.famousenuf.com" style={{ textDecoration: 'none' }}  className={a3.join(' ')} >Login</a></li>
